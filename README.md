...
![Версия](https://img.shields.io/badge/version-2.6.2.2-blue)
...
- **Срочные задачи (⚡)** — правый клик → «Срочное». Увеличенный шрифт, значок ⚡, закрепление вверху колонки в напоминании.
- **Таймер и полноэкранное напоминание** — 4 колонки (ToDo-1/2, Started-1/2) с адаптивным размером шрифта: текст всегда помещается по высоте и ширине. Поверх всех окон.
...
- **Автоудаление Done** — выполненные задачи удаляются при запуске приложения и при ежедневном сбросе регулярных задач.
