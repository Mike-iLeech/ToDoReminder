...
<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">6. Таймер и полноэкранное напоминание</h3>
<ul style="margin:0; padding-left:20px;">
...
<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">7. Настройки</h3>
<ul style="margin:0; padding-left:20px;">
...
<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">8. Системный трей</h3>
<ul style="margin:0; padding-left:20px;">
...
<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">9. Прочее</h3>
<ul style="margin:0; padding-left:20px;">
