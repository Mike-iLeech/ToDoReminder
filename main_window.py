...
<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">5. Срочные дела</h3>
<ul style="margin:0; padding-left:20px;">
<li><b>ПКМ</b> по карточке → пункт <b>«Срочное»</b> (отмечается галочкой). Отметить срочным можно любое активное дело (To Do или Started).</li>
<li>Срочные дела помечаются значком <b>⚡</b>, отображаются <b>жирным шрифтом увеличенного размера</b> и закрепляются в <b>самом верху списка</b> — выше всех остальных активных дел.</li>
<li>В полноэкранном напоминании срочные дела также выводятся <b>наверху каждой колонки</b> (To Do и Started) с увеличенным шрифтом и выделенным цветом.</li>
<li>Срочные дела <b>нельзя перетащить</b> — они всегда остаются наверху, пока не будут выполнены или снята отметка срочности.</li>
<li>После выполнения (Done) дело теряет приоритет и опускается в блок выполненных. Отметку срочности можно снять в любой момент через <b>ПКМ → «Убрать срочность»</b>.</li>
</ul>

<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">6. Автоудаление выполненных дел</h3>
<ul style="margin:0; padding-left:20px;">
<li>Дела со статусом <b>Done автоматически удаляются</b>:</li>
<li>— при наступлении <b>нового календарного дня</b> (даже если приложение было закрыто);</li>
<li>— при каждом <b>запуске приложения</b> (включая перезагрузку компьютера).</li>
<li>Это позволяет держать список чистым: выполненные дела не накапливаются.</li>
</ul>

<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">7. Таймер и полноэкранное напоминание</h3>
<ul style="margin:0; padding-left:20px;">
...
<li>Напоминание — <b>настраиваемое число колонок</b> для каждого статуса (To Do, Started и Done отдельно, от 1 до 8). Задачи распределяются поочерёдно (round-robin) между колонками своего статуса. Между колонками — вертикальные разделительные линии.</li>
<li>Слева от каждого дела — <b>цветной маркер</b> статуса. Срочные дела помечены значком <b>⚡</b>, выделены увеличенным шрифтом и цветом, закреплены наверху своей колонки.</li>
<li><b>Адаптивный размер шрифта:</b> если задач много или текст длинный, размер автоматически уменьшается (но не ниже минимального), чтобы всё поместилось в высоту экрана с учётом переноса строк.</li>
<li>Выполненные дела в напоминании по умолчанию скрыты; при включённой настройке они занимают <b>дополнительные колонки</b> (число настраивается отдельно) и выводятся зачёркнутым шрифтом.</li>
<li>Закрыть: <b>клик мышкой</b> или <b>Enter / Space / Esc</b>.</li>
</ul>

<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">8. Настройки</h3>
<ul style="margin:0; padding-left:20px;">
<li><b>Интервал напоминаний</b> (в минутах).</li>
<li><b>Выводить выполненные дела</b> в уведомлении.</li>
<li><b>Колонки To Do / Started / Done</b> — число колонок для каждого статуса в полноэкранном уведомлении (1–8). Настройка «Колонки Done» видна только при включённом выводе выполненных дел.</li>
...
<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">9. Системный трей</h3>
<ul style="margin:0; padding-left:20px;">
...
<h3 style="color:{accent}; font-size:16px; margin:14px 0 6px 0;">10. Прочее</h3>
<ul style="margin:0; padding-left:20px;">
