...
<li>Напоминание — <b>настраиваемое число колонок</b> для каждого статуса (To Do и Started отдельно, от 1 до 8). Задачи распределяются поочерёдно (round-robin) между колонками своего статуса. Между колонками — вертикальные разделительные линии.</li>
...
<li>Выполненные дела в напоминании по умолчанию скрыты; при включённой настройке они занимают <b>дополнительные колонки</b> (число = число колонок To Do) и выводятся зачёркнутым шрифтом.</li>
...
<li><b>Колонки To Do / Started</b> — число колонок для каждого статуса в полноэкранном уведомлении (1–8).</li>
