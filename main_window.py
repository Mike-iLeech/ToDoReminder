...
<li>Напоминание — <b>4 колонки</b>: ToDo-1, ToDo-2, Started-1, Started-2. Задачи распределяются поочерёдно (round-robin) между двумя колонками своего статуса. Между колонками — вертикальные разделительные линии.</li>
...
<li>Выполненные дела в напоминании по умолчанию скрыты; при включённой настройке они занимают <b>2 дополнительные колонки</b> (Done-1, Done-2) и выводятся зачёркнутым шрифтом.</li>
